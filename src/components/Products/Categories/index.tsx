    ...
    const item: CategoriesItems[] = [
        {
            title: "House Plants",
            id: 1,
            count: categoriesData["House Plants"] || 0,
        },
        {
            title: "Potter Plants",
            id: 2,
            count: categoriesData["Potter Plants"] || 0,
        },
        { title: "Seeds", id: 3, count: categoriesData["Seeds"] || 0 },
        {
            title: "Small Plants",
            id: 4,
            count: categoriesData["Small Plants"] || 0,
        },
        {
            title: "Big Plants",
            id: 5,
            count: categoriesData["Big Plants"] || 0,
        },
        {
            title: "Succulents",
            id: 6,
            count: categoriesData["Succulents"] || 0,
        },
        {
            title: "Terrariums",
            id: 7,
            count: categoriesData["Terrariums"] || 0,
        },
        { title: "Gardening", id: 8, count: categoriesData["Gardening"] || 0 },
        {
            title: "Accessories",
            id: 9,
            count: categoriesData["Accessories"] || 0,
        },
    ];
