        ...
        <div className={s.header}>
            ...
            <ul>
                ...
                <li>
                    <Link
                        className={
                            location.pathname === "/Shop/Cart" ? s.active : ""
                        }
                        to="/Shop/Cart"
                    >
                        Shop
                ...
                <li>
                    <Link
                        className={
                            location.pathname === "/plantCare" ? s.active : ""
                        }
                        to=""
                    >
                        Plant Care
                ...
                <li>
                    <Link
                        className={
                            location.pathname === "/blogs" ? s.active : ""
                        }
                        to=""
                    >
                        Blogs
            ...
            <div>
                <div className={s.cart}>
                    ...
                    {isUserLoggedIn() && userData?.cartCount !== 0 && (
                ...
                {isUserLoggedIn() ? (
                    <Link className={s.account} to="/account">
                        {userData?.profileImg ? (
                            <img
                                width={28}
                                src={`https://greenshopfrontend-production.up.railway.app/${userData.profileImg}`}
                                alt="user"
                            />
                        ) : (
                            <img
